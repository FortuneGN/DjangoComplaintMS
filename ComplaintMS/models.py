...
class Profile(models.Model):
    ...
    CB=(('Software Engineering',"Software Engineering"),('Computer Science',"Computer Science"),('Information Systems',"Information Systems"),('Data Science',"Data Science"))
    Branch=models.CharField(choices=CB,max_length=29,default='Computer Science')
    def __str__(self):
